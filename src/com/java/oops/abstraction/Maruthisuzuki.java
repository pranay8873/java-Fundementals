...
public class Maruthisuzuki extends Service {
    Scanner sc=new Scanner(System.in);
    String brand;
    int bill=0;

    public Maruthisuzuki(int id, String customerName, String vehicle, String model) {
    ...
    @Override
    public void general(){
        System.out.println("For General Servicing it costs INR: 1500.00");
    }
